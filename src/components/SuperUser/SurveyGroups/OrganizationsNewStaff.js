...
const OrganizationsNewStaff = ({ loading }) => {
  return (
    <MainLayout
      titleClass="mt-3"
    ...
    >
      <div className="grid grid-cols-12 items-center justify-center min-h-screen">
        ...
        >
          ...
          <Input name="name" labelText="Name" placeholder="Name" wrapperClassName="mb-2" />
          <Input name="email" labelText="Email" placeholder="Email" wrapperClassName="mb-2" />
          <Input
            name="password"
            labelText="Password"
