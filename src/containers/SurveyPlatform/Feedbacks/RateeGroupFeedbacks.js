...
import Layout from '../../../components/SurveyPlatform/Feedbacks/RateeGroupFeedbacks';

class RateeGroupFeedbacks extends Component {
  state = {};
...
export default connect(mapStateToProps, mapDispatchToProps)(RateeGroupFeedbacks);
